...
namespace Markatooo.Controllers
{
    ...
    public class GatewaysController : Controller
    {
        ...
        public GatewaysController(MarkatoooContext context) {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<IActionResult> Getgateways(DataSourceLoadOptions loadOptions)
        {
            var gateways = _context.Gateways.Where(e=>e.GateWayId!=4).Select(i => new {
                i.GateWayId,
                i.Title,
                i.TestURL,
                i.UserName,
        ...
        private void PopulateModel(Gateway model, IDictionary values) {
            ...
            string IS_ACTIVE = nameof(Gateway.isActive);
