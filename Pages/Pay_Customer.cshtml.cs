...
{
    public class Pay_CustomerModel : PageModel
    {
        ...
        public Pay_CustomerModel(MarkatoooContext context, IToastNotification toastNotification)
        {
            httpClient = new HttpClient();
            _context = context;
            _toastNotification = toastNotification;
        }
        public async Task<IActionResult> OnGet(int paymentid)
        {
            var transaction = _context.Payments.FirstOrDefault(e => e.PaymentModelId == paymentid);
            ...
            if (transaction.GateWayId == 1)
            {
                ...
                //    {
                //        operation = "PURCHASE",
                //        returnUrl = "https://markatooo.beintrackpay.com/returnUrl?orderId=" + transaction.OrderNumber
            ...
            else if (transaction.GateWayId == 2)
            {
                ...
                if (cBKAuthToken.Status == "1")
                {
                    var values = new NameValueCollection
                    {
                        ...
                        ["tij_MerchReturnUrl"] = "https://markatooo.beintrackpay.com/Response"
                    };
