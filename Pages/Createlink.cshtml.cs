...
namespace Markatooo.Areas.Admin.Pages.Customer
{
    public class CreatelinkModel : PageModel
    {
        ...
        public CreatelinkModel(MarkatoooContext context, IWebHostEnvironment hostEnvironment, IToastNotification toastNotification, UserManager<ApplicationUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPost(IFormFile file)
        {
            ...
            return RedirectToPage("Pay_Customer", new { paymentid = model.PaymentModelId });
        }
