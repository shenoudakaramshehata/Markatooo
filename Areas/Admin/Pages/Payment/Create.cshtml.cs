...
namespace Markatooo.Areas.Admin.Pages.Payment
{
    ...
    public class CreateModel : PageModel
    {
        ...
        public CreateModel(MarkatoooContext context, IWebHostEnvironment hostEnvironment, IToastNotification toastNotification,UserManager<ApplicationUser> userManager )
        {
            _context = context;
